...
public interface UserManager {
     ...
     *
     * @param user
     *     the user to fetch the information about
     *
     ...
     *
     * @param profile
     *     the profile to base the new user off
     * @param password
     ...
     *
     * @param profile
     *     the profile of the user to delete
     *
    ...
    /**
     * Fetch user profiles for all the users held in the remote servers user database.
     *
