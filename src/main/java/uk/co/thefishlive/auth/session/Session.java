...
/**
 * Represents an active login session, used to authenticated with the remote
 * server.
 */
public interface Session extends Identifiable<UserProfile> {
     ...
     * @throws IOException if the request was network error causing the request
     *      to not be carried out
     * @throws SessionException if the remote server refused the authentication
     *      details provided
     */
